...
\pgfdeclareimage[height=1.4cm]{psglogo}{./include/logos/potassco-solutions/Logo_ohne_Claim/Digital/psg_rgb_2colors_digital.png}
\pgfdeclareimage[height=0.5cm]{psgicon}{./include/logos/potassco-solutions/Icon/Digital/psg_icon_rgb_deep_blue_digital.png}
...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.25ex,dp=1ex,leftskip=6pt]{title in head/foot}%
    \usebeamerfont{title in head/foot}\insertshorttitle\hspace{20pt}
  \end{beamercolorbox}%
...
% Footer colors
\setbeamercolor{author in head/foot}{bg=potnavy!60, fg=white}
\setbeamercolor{title in head/foot}{bg=potnavy!75!black, fg=white}
\setbeamercolor{logo in head/foot}{bg=potnavy, fg=white}
...
\setbeamercolor{block title}{fg=white, bg=potnavy!80}
\setbeamercolor{block body}{fg=potnavy, bg=potnavy!8}
\setbeamercolor{block title example}{fg=white, bg=potgreen}
\setbeamercolor{block body example}{fg=potnavy, bg=potgreen!30}
\setbeamercolor{block title alerted}{fg=white, bg=potblue}
\setbeamercolor{block body alerted}{fg=potnavy, bg=potblue!8}
